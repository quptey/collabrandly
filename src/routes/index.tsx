...
import { CATEGORIES, getCategoryLabel, type Category } from "@/lib/constants";
...
function Landing() {
  ...
  const { data: featuredCreators = [] } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await supabase
        .from("profiles")
        .select(
          "id, display_name, avatar_url, category, custom_category, city, follower_range, bio",
        )
        .eq("role", "creator")
        ...
        <div className="mt-10 text-center sm:hidden">
          <Link to="/marketplace">
            <Button variant="outline" className="rounded-2xl">
              {t("marketplace.viewAll")} <ArrowRight className="ml-1 h-4 w-4" />
            </Button>
          </Link>
        </div>
      </section>
  ...
  function CreatorBenefits() {
    return (
      <BenefitSection
        ...
        items={[
          t("landing.creatorBenefit1"),
          t("landing.creatorBenefit2"),
          t("landing.creatorBenefit3"),
        ]}
        accent={Heart}
        cta={{
          label: t("nav.joinCreator"),
          to: "/auth",
  ...
  function PlatformStats() {
    ...
    return (
      <section className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
        ...
        <div className="mt-10 sm:mt-14 grid gap-4 sm:gap-6 grid-cols-2 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            {
              label: t("landing.statCollaborations"),
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: i * 0.1 }}
              className="rounded-3xl border border-border bg-card p-4 sm:p-8 text-center hover-lift"
            >
              <s.icon className="mx-auto h-8 w-8 text-accent" />
              <p className="mt-4 font-display text-4xl font-semibold">{s.value.toLocaleString()}</p>
  ...
  function Pricing() {
    const freeFeatures = [
      t("landing.creatorBenefit1"),
      t("landing.creatorBenefit3"),
      t("subscription.limitedCollections"),
      t("subscription.limitedProducts"),
    ];
    const proFeatures = [
      t("subscription.proUnlimited"),
      t("subscription.priorityRanking"),
      t("subscription.proBadge"),
      t("subscription.analytics"),
      t("subscription.featuredCreator"),
    ];
    const brandFeatures = [
      t("subscription.unlimitedSearch"),
      t("subscription.advancedFilters"),
      t("subscription.saveCreators"),
      t("subscription.unlimitedRequests"),
      t("subscription.campaignManagement"),
    ];
    return (
      <section className="border-y border-border bg-cream">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
          ...
          <div className="mt-10 sm:mt-14 grid gap-4 sm:gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-border bg-card p-6 sm:p-8">
              ...
              <div className="mt-3">
                <p className="font-display text-4xl font-semibold text-muted-foreground line-through">
            ...
            <div className="relative rounded-3xl border-2 border-foreground bg-foreground p-6 sm:p-8 text-background shadow-xl">
              ...
              <p className="text-xs font-semibold uppercase tracking-wider text-background/60">
                {t("subscription.creatorPro")}
              </p>
              <div className="mt-3">
                <p className="font-display text-4xl font-semibold text-background/60 line-through">
  ...
  function FAQ() {
    ...
    return (
      <section className="mx-auto max-w-3xl px-6 py-16 lg:py-24">
        ...
        <h2 className="mt-2 font-display text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight">
          {t("landing.faqTitle")}
        </h2>
...
function BenefitSection({
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16 lg:py-24">
      <div
        className={`grid items-center gap-8 lg:gap-12 lg:grid-cols-2 ${reverse ? "lg:[&>*:first-child]:order-2" : ""}`}
      >
        <div>
          ...
          <Link to={cta.to as never} search={cta.search as never} className="mt-8 inline-block">
            <Button variant="accent" size="lg" className="rounded-full px-6">
        ...
        <div className="relative mx-auto w-full max-w-[370px] aspect-[9/16] overflow-hidden rounded-3xl bg-gradient-to-br from-warm via-cream to-background p-12">
          {Icon === Heart ? (
            <div className="absolute inset-8 overflow-y-auto overflow-x-hidden rounded-2xl bg-white shadow-xl [&::-webkit-scrollbar]:hidden">
              ...
              <div className="flex items-center justify-between px-4 py-2.5">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  >
                    <path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8m-4-6-4-4-4 4m4-4v12" />
                  </svg>
                  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-gray-600">
              ...
              <div className="flex items-start gap-3.5 px-4 pt-3 pb-2.5">
                <div className="h-20 w-20 shrink-0 overflow-hidden rounded-full border-[3px] border-white shadow-md">
                  <img
                    src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=200&h=200&fit=crop&crop=face"
                    alt=""
                    className="h-full w-full object-cover"
                  />
                </div>
              ...
              <div className="mx-4 mb-3 mt-2 flex divide-x divide-gray-100 overflow-hidden rounded-2xl bg-gray-50 shadow-sm">
                {[
                  { label: t("landing.mock.followers"), value: t("landing.mock.followersValue") },
                  { label: t("landing.mock.products"), value: t("landing.mock.productsValue") },
                  {
                    label: t("landing.mock.collections"),
                    value: t("landing.mock.collectionsValue"),
                  },
                ].map((s) => (
              ...
              <div className="px-4 pb-3">
                <div className="mb-2.5 flex items-center justify-between">
                  <p className="font-display text-sm font-semibold tracking-tight text-[#1A1A1A]">
                    {t("landing.mock.featuredProducts")}
                  </p>
                  <span className="cursor-pointer text-[8px] text-gray-400 transition-opacity hover:opacity-60">
                    {t("landing.mock.seeAll")}
                  </span>
                </div>
                <div className="flex gap-2 overflow-x-auto [&::-webkit-scrollbar]:hidden">
                  {[
                    {
                      name: t("landing.mock.product1Name"),
                      price: t("landing.mock.product1Price"),
                      img: "https://images.unsplash.com/photo-1559070081-648fb00b2ed1?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.product2Name"),
                      price: t("landing.mock.product2Price"),
                      img: "https://images.unsplash.com/photo-1598532163257-ae3c6b2524b6?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.product3Name"),
                      price: t("landing.mock.product3Price"),
                      img: "https://images.unsplash.com/photo-1760920248537-c1185bbc5c61?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.product4Name"),
                      price: t("landing.mock.product4Price"),
                      img: "https://images.unsplash.com/photo-1767391255584-763f98ced9d0?w=200&h=200&fit=crop&crop=center",
                    },
                  ].map((p) => (
                    <div
                      key={p.name}
                      className="group w-[95px] shrink-0 overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md"
                    >
              ...
              <div className="px-4 pb-3">
                <div className="mb-2.5 flex items-center justify-between">
                  <p className="font-display text-sm font-semibold tracking-tight text-[#1A1A1A]">
                    {t("landing.mock.summerFavorites")}
                  </p>
                  <span className="cursor-pointer text-[8px] text-gray-400 transition-opacity hover:opacity-60">
                    {t("landing.mock.seeAll")}
                  </span>
                ...
                <div className="flex gap-2 overflow-x-auto [&::-webkit-scrollbar]:hidden">
                  {[
                    {
                      name: t("landing.mock.summer1Name"),
                      price: t("landing.mock.summer1Price"),
                      img: "https://images.unsplash.com/photo-1565276645994-f72f0598febf?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.summer2Name"),
                      price: t("landing.mock.summer2Price"),
                      img: "https://images.unsplash.com/photo-1565592284342-7ed1636f409f?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.summer3Name"),
                      price: t("landing.mock.summer3Price"),
                      img: "https://images.unsplash.com/photo-1601980265524-04468b355ac3?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.summer4Name"),
                      price: t("landing.mock.summer4Price"),
                      img: "https://images.unsplash.com/photo-1625899845678-3fad6a4a1846?w=200&h=200&fit=crop&crop=center",
                    },
                  ].map((p) => (
                    <div
                      key={p.name}
                      className="group w-[80px] shrink-0 overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md"
                    >
                      <div className="relative aspect-square">
                        <img
                          src={p.img}
                      ...
                      <div className="p-1.5">
                        ...
                        {p.price && (
                          <p className="mt-0.5 text-[8px] font-semibold text-gray-700">{p.price}</p>
                        )}
                      </div>
                    </div>
                  ))}
              ...
              <div className="px-4 pb-3">
                <div className="mb-2.5 flex items-center justify-between">
                  <p className="font-display text-sm font-semibold tracking-tight text-[#1A1A1A]">
                    {t("landing.mock.collectionsTitle")}
                  </p>
                  <span className="cursor-pointer text-[8px] text-gray-400 transition-opacity hover:opacity-60">
                    {t("landing.mock.seeAll")}
                  </span>
                ...
                <div className="flex gap-2 overflow-x-auto [&::-webkit-scrollbar]:hidden">
                  {[
                    {
                      name: t("landing.mock.collection1Name"),
                      img: "https://images.unsplash.com/photo-1598532163257-ae3c6b2524b6?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.collection2Name"),
                      img: "https://images.unsplash.com/photo-1657603726278-a9f12ca2c8d7?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.collection3Name"),
                      img: "https://images.unsplash.com/photo-1664623737694-fd3d0e144842?w=200&h=200&fit=crop&crop=center",
                    },
                    {
                      name: t("landing.mock.collection4Name"),
                      img: "https://images.unsplash.com/photo-1547949003-9792a18a2601?w=200&h=200&fit=crop&crop=center",
                    },
                  ].map((c) => (
                    <div
                      key={c.name}
                      className="group w-[90px] shrink-0 overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md"
                    >
                      <div className="relative aspect-square">
                        <img
                          src={c.img}
            ...
            <div className="absolute inset-8 overflow-hidden rounded-2xl shadow-xl">
              <img
                src="/brand/photo_5341643752684067534_y.jpg"
                alt="Brand collaboration showcase"
                className="h-full w-full object-cover"
              />
            </div>
          )}
