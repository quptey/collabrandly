  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-10 sm:mt-14 grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-3 lg:gap-6">
          {/* Free Plan */}
          <div className="relative flex flex-col rounded-3xl border border-border bg-card p-6 sm:p-8">
          ...
          <div className="relative flex flex-col rounded-3xl border-2 border-foreground bg-foreground p-6 sm:p-8 text-background shadow-xl">
          ...
          <div className="relative flex flex-col rounded-3xl border border-border bg-card p-6 sm:p-8">
            ...
            <p className="mt-4 text-xs font-semibold uppercase tracking-wider text-[#92400E]">
            ...
            <div className="mt-8">
              {user && plan?.key === "brand" ? (
                ...
                <Link to="/auth" search={{ mode: "signup", role: "brand" }}>
                  <Button className="w-full rounded-full">{t("subscription.startFree")}</Button>
                </Link>
              )}
            </div>
          </div>
        ...
        <div className="mt-16 rounded-3xl border border-border bg-card p-8 text-center">
          ...
          <Button
            ...
            onClick={() => window.open("mailto:hello@creator-kz.kz")}
          >
